...
public class Maize_g_O extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maize_go);
    ...
    private void calculateSeeds() {
        ...
        try {
            ...
            // 1 acre needs approximately 20-25 kg seeds for Maize.
            double seedPerAcre = 22.0; // Taking average value
