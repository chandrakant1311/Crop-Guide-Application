...
public class Sesame_g_O extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sesame_go);
    ...
    private void calculateSeeds() {
        ...
        try {
            ...
            // 1 acre needs approximately 4-5 kg seeds for Sesame.
            double seedPerAcre = 4.5; // Taking average value
