...
import com.example.multipage.Grains.GrainO;
import com.example.multipage.R;
import com.example.multipage.Schemes.SchemeO;
import com.example.multipage.StateSelection;
import com.example.multipage.Vegetables.VegetableO;
import com.example.multipage.fruits.FruitsO;

public class MenuOdisha extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_menu_odisha);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(MenuOdisha.this, StateSelection.class);
