...
public class wheat_g_Mh extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wheat_gmh);
    ...
    private void calculateSeeds() {
        ...
        try {
            ...
            // 1 acre needs approximately 50 kg seeds
            double seedPerAcre = 50.0;
